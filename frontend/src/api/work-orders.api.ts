...
import type { WorkOrder, WorkOrderStatus, WorkOrderFilterParams, CreateWorkOrderData, UpdateWorkOrderData, AddMaterialData, WorkOrderMaterial } from '../types/work-order.types';
...
export const workOrdersApi = {
  ...
  update: (id: number, data: UpdateWorkOrderData) =>
    api.patch<WorkOrder>(`/work-orders/${id}`, data).then(r => r.data),
